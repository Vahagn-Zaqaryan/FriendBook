...
.styled-button-10:hover {
	...
	<h1><img class="title_icons"src="logos/icons/edit_settings.png"> Update Password</h1>
	<?php 
		if (empty($_POST) === false && empty($errors) === true) {
			...
			$query= mysql_query("UPDATE  `database`.`data` SET  `password` =  '$password' WHERE  `data`.`id` = \"$id\" ");
	...
	<form action="" method="POST">
		...
		<li>
			<input type="submit" value="Change" class="styled-button-10">
		</li>
	</form>
	<div id="searchbox">
